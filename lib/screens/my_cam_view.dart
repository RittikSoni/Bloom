...
//   /// Default Constructor
//   const MyCamView({super.key});

//   @override
//   State<MyCamView> createState() => _MyCamViewState();
// }
...
//     print('Picture captured to: ${file.path}');
//   }
...
//           print('Video captured to: ${file.path}');
//         }
...
//             //   ],
//             // ),
//             _initialized && _cameraId > 0 && _previewSize != null
//                 ? Padding(
//                   padding: const EdgeInsets.symmetric(vertical: 10),
//                   child: Align(
//                     child: Container(
